...
<div class="row">
    ...
    <div class="card ">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{route('discount.update',['discount'=>$Discount->id])}}"   method="post">
              @method('PATCH')
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="date" min="0" name="expired_at" class="form-control" id="inputPassword3" placeholder="تاریخ تولد کارت را وارد کنید">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <span class="btn btn-info" >{{$user->name ?? $user->phonenumber}}</span>
                    @endforeach
                    <br><br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <span class="btn btn-info mb-2" >{{$user->name ?? $user->phonenumber}}</span>
                        @endforeach
                        <br><br>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-info">ایجاد تخفیف</button>
