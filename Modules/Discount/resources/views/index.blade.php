...
@section('content')
    <h1>Hello World</h1>
    <p>Module: {!! config('discount.name') !!}</p>
@endsection -->
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                  ...
                  <tr>
                    ...
                    <td class="d-flex"><a href="{{route('admin_blog.show', ['admin_blog'=>$discount->id])}}"><button class="btn btn-primary"><span class="badge badge-primary">ویرایش</span></button></a>
                    <form action="{{route('admin_blog.destroy', ['admin_blog'=>$discount->id])}}" method="post" class="mr-1">
                        @csrf
                        @method('DELETE')
